...
ANNOTATION_FILE = "../annotations/phoenix14t.pami0.train.annotations_only.gzip"
OUTPUT_FILE = "train_selected_annotations.txt"
...
selected_order = sorted([
    f.replace(".mp4", "")
    for f in os.listdir(TRAIN_VIDEO_DIR)
    if f.endswith(".mp4")
])
