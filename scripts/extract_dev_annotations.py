...
# PATHS (FIX THIS PATH)
# --------------------------------------------------
DEV_VIDEO_DIR = "../dataset/dev"
ANNOTATION_FILE = "../annotations/phoenix14t.pami0.dev.annotations_only.gzip"
OUTPUT_FILE = "dev_selected_annotations.txt"
...
selected_order = sorted([
    f.replace(".mp4", "")
    for f in os.listdir(DEV_VIDEO_DIR)
    if f.endswith(".mp4")
])
